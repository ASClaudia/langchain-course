...
def implement_query_model(model, prompt):
    ...
    return model.invoke(list(prompt)).content
...
def implement_compare_models(prompt):
    ...
    return {"llama4_response": implement_query_model(implement_llama_4_model(), prompt),
            "llama3_response": implement_query_model(implement_llama_3_3_model(), prompt)}
